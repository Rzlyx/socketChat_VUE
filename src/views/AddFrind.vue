...
export default {
    ...
    methods: {
        ...
        async Submit() {
            try {
                const response = await this.$http.post('http://192.168.2.220:8070/addFriend', this.form);
    ...
    created() {
        ...
        // const response = this.$http.post('http://192.168.2.220:8070/queryFriendApply', window.sessionStorage.getItem("userid"));
        if (response.data.code !== 1000) {
