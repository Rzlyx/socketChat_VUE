...
export default {
    ...
    methods: {
        ...
        async searchGroup() {// 搜索群聊,查看群信息
            ...
            await this.$http.post('http://192.168.2.220:8070/QueryGroupInfo', { group_id: this.searchG}).then(response => {
        ...
        ApplyAG() {//申请加群
            ...
            // this.$http.post('http://192.168.2.220:8070/group_id', this.applyfrom).then(response => {
            //     if (response.data.code !== 1000) {
    ...
    created() {
        ...
        // const response = this.$http.post('http://192.168.2.220:8070/queryGroupApply', window.sessionStorage.getItem("userid"));
        // if (response.data.code !== 1000) {
